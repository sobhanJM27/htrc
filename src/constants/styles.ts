...
export const bgButton2 =
  "border border-border bg-transparent text-foreground before:absolute! before:inset-0 before:z-[-1] before:bg-accent before:translate-y-full hover:before:translate-y-0 hover:text-accent-foreground before:transition-transfor before:duration-300";
export const bgButton3 =
  "bg-transparent! before:absolute before:inset-0 before:z-[-1] before:bg-muted/30  before:translate-y-full hover:before:translate-y-0 before:transition-transform before:duration-300";

export const border1 = "border border-border";
